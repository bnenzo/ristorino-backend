...
public class SOAPClient {
  ...
  private <T> T processResponseForObject(SOAPMessage soapResponse, Class<T> clazz, String responseElementName)
      throws Exception {
  ...
  private <T> List<T> processResponseForList(SOAPMessage soapResponse, Class<T> clazz, String responseElementName)
      throws Exception {
    List<T> objectList = new LinkedList<>();
    processResponse(soapResponse, clazz, responseElementName, objectList);
    return objectList;
  ...
  private <T> void processResponse(SOAPMessage soapResponse, Class<T> clazz, String responseElementName,
      List<T> objectList) throws Exception {
